...
namespace VST {
    ...
    static const FUID FogPadWithSideChainProcessorUID( 0xE7EA2412, 0xF8C211E9, 0xB2C4B28D, 0x42644A14 );
    static const FUID FogPadControllerUID( 0xFB060EF8, 0xF8C211E9, 0xB9B1258E, 0x42644A14 );
